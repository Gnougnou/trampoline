 ...
 * Automatically generated by goil on Wed May 18 11:13:14 2016
...
/* Task task_hello identifier */
#define task_hello_id 0
CONST(TaskType, AUTOMATIC) task_hello = task_hello_id;
 ...
 */
/*-----------------------------------------------------------------------------
 * Task task_hello descriptor
 */
#define APP_Task_task_hello_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task task_hello function prototype
 */

FUNC(void, OS_APPL_CODE) task_hello_function(void);
#define APP_Task_task_hello_STOP_SEC_CODE
 ...
 */
/*
 * Task task_hello stack
 */
#define APP_Task_task_hello_START_SEC_STACK
#include "tpl_memmap.h"
tpl_stack_word task_hello_stack_zone[32768/sizeof(tpl_stack_word)];
#define APP_Task_task_hello_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_STACK task_hello_stack = {task_hello_stack_zone, 32768};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"

#define task_hello_STACK &task_hello_stack

/*
 * Task task_hello context
 */
#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_CONTEXT task_hello_context;
#define OS_STOP_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define task_hello_CONTEXT &task_hello_context
...
/*
 * Static descriptor of task task_hello
 */
CONST(tpl_proc_static, OS_CONST) task_hello_task_stat_desc = {
  /* context                  */  task_hello_CONTEXT,
  /* stack                    */  task_hello_STACK,
  /* entry point (function)   */  task_hello_function,
  /* internal ressource       */  NULL,
  /* task id                  */  task_hello_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
#endif
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task task_hello
 */
VAR(tpl_proc, OS_VAR) task_hello_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
